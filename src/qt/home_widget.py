...
class HomeWidget(QWidget):
    ...
    def refresh_data(self):
        ...
        data = [("Concert de Rock", "Concert", "2026-07-15", "20:00"),
            ("Exposition d'Art", "Exposition", "2026-08-01", "10:00"),
            ("Festival de Jazz", "Festival", "2026-09-10", "18:30"),
            ("Conférence Tech", "Conférence", "2026-10-05", "09:00"),
